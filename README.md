...
- библиотека для работы с Rabbit MQ - nestjs-rmq (под капотом - ampqlib)
- тестирование - jest
...
Libraries are shareable across libraries and applications. They can be imported from `@rabbit-worker/mylib`.
